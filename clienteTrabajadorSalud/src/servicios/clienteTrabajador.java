...
/**
 * Jersey REST client generated for REST resource:TrabajadorSaludFacadeREST
 * [entidades.trabajadorsalud]<br>
 * USAGE:
 * <pre>
 *        clienteTrabajador client = new clienteTrabajador();
...
public class clienteTrabajador {
    ...
    public clienteTrabajador() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entidades.trabajadorsalud");
    }
    ...
    public <T> T findByCedula_XML(Class<T> responseType) throws ClientErrorException {
        WebTarget resource = webTarget;
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T findByCedula_JSON(Class<T> responseType) throws ClientErrorException {
        WebTarget resource = webTarget;
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
